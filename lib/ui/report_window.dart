  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot snapshot) {
        Map<DateTime, List<HistoryItemData>> history = StoreProvider.historyState.history;
        ...
        for (final entry in history.entries) {
           List<HistoryItemData> items = entry.value;
            ...
            totalSums[activityId] = totalSums[activityId] ?? const Duration(seconds: 0) + (duration);
            }
        }
        ...
        return SingleChildScrollView(
          ...
          child: DataTable(
              ...
              rows: [
                ...
                DataRow(cells: [DataCell(Text("Total")), ...List.generate(
                    length,
